/* 
This code makes a Tekbot follow a track of black tape with the QRE113 analog reflectivity sensor
Authors: Aaron Rito, Chris Hogan
Date: 11/6/14
*/

//motor controls, Enable and Direction
int EN1 = 10;
int EN2 = 5;
int DIR1 = 11;
int DIR2 = 6;

// sensor pins and indicator lights
...
void loop() {
    ...
    // Setup the sensor values to handle 16 bit. 0 is non-reflective, 255 is reflective.
    ...
    // call the turn functions if the sensor detects a non-reflective surface
